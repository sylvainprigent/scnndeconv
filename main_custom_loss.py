...
gt_image_file = 'data/Lyon_1842_5175_50cm_F06opt_32bits.tif'
test_img_file = 'data/Lyon_1842_5175_50cm_F06opt_w1.0_reg12_HSV.tif'
...
loss_acontrario = SAContrarioLoss(radius=1, alpha=7, beta=0.01, gamma=1)
